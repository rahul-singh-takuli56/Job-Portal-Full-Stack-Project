...
const MyJobs = () => {
  ...
  useEffect(() => {
    setisLoading(true);
    fetch(`http://localhost:3000/myJobs/rahulsinghkb56@gmail.com`)
      .then((res) => res.json())
      .then((data) => {
        setJobs(data);
        setisLoading(false);
  ...
  const handleSearch = () => {
    /*filter data on the basis of Job Title */
  ...
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4">
      <div className="my-job-container">
        <h1 className="text-center text-2xl text-blue font-semibold underline uppercase p-4">
          All My Jobs
        </h1>
